...
class ApiEndpoints {
  ...
  static const String SAVE_TOKEN_FCM = "$BASE_URL/api/auth/save-tokenFcm";
  ...
  static const String RESET_PASSWORD_CONFIRM =
  ...
  static String adminUserDetail(int userId) =>
      "$BASE_URL/dashboard/users/$userId";
  static const String ADMIN_RESET_PASSWORD =
      "$BASE_URL/dashboard/reset/password";
  static const String ADMIN_RESET_PASSWORD_CONFIRM =
      "$BASE_URL/dashboard/reset/password/confirm";
  static const String FOOD_DIARY_ANALYSIS =
      "$BASE_URL/api/habit/food/diary/analysis";

  static const String VIDEO = "$BASE_URL/api/video/";
  static const String VIDEO_CLAIM_REWARD = "$BASE_URL/api/video/claim-reward";
  static const String PROFESSIONAL_LIST =
      "$BASE_URL/api/appointment/professionals";
  static const String APPOINTMENT = "$BASE_URL/api/appointment/";
  static const String DASHBOARD_NOTIFICATION =
      "$BASE_URL/api/users/notification/reminder";
  ...
  static const String NUTRITION_CALCULATOR =
      "$BASE_URL/api/user/nutrition/calculator";
